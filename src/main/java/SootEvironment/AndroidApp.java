	 ...
	 public  AndroidApp(String androidpath, String ApkPath,String classlist)
	 {
		 //String rtpath="/home/dingli/AppChecker/libs/rt.jar";
	        ...
	        Options.v().set_src_prec(Options.src_prec_apk);
	      	...
	      	//System.out.println(scc.getMethods());
			...
			try {
	      	...
	      	//Scene.v().addBasicClass("usc.sql.log.InstrumentHelper");
	      	//SootClass scc=Scene.v().loadClassAndSupport("usc.sql.log.InstrumentHelper");
	      	//scc.setApplicationClass();
